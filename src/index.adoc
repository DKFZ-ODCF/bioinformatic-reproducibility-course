...
== Programming
  ...
  * Communication
    - computer must understand code
    - your future you must understand your code
    - others must understand your code
  * Decide yourself
      * Code 2, 3, ... times the same code
      * Write it once (with test!)
  * Complexity management

  * Bash is programming (but avoid Bash ;-) )
...
=== Terms
  ...
  * Registering a version to track is called "committing"
