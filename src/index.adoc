...
+
image::13742_2016_135_Fig5_HTML.jpg[Virtualization, https://dx.doi.org/10.1186%2Fs13742-016-0135-4]
    - Containerization uses the host-operating system but provides separate environment for software deployment and execution
+
image::13742_2016_135_Fig6_HTML.jpg[Containers, https://dx.doi.org/10.1186%2Fs13742-016-0135-4]
